<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<form name="imageboardWriteForm2" id="imageboardWriteForm2" method="post"
...
<div style="width: 60%;">
	...
	<div class="ui inverted input" style="width: 100%;">
  	...
  	<div class="ui inverted input" style="width: 100%;">
		<div class="ui left icon input" style="width: 100%; height: 50px;">
			<input type="text" name="eventPlace" placeholder="행사장소">
			<i class="user icon"></i>
		</div>
  	</div>
  	<br><br>
  	...
  	<div class="ui inverted input" style="width: 100%;">
		<div class="ui left icon input" style="width: 100%; height: 50px;">
			<input type="text" name="eventPrice" placeholder="행사가격">
			<i class="user icon"></i>
		</div>
  	</div>
  	<br><br>
