			...
			<div class="ui labeled input " style="margin-top: 20px;">
				...
				<div class="ui inverted input" style="width: 100%;">
					<div class="ui left icon input focus" style="width: 100%; height: 50px;">
						<input type="text" name="startDate" class="datepicker1" style="width:205px;">
						<input type="hidden" id="startDate" value="${eventboardDTO.startDate}" >
						<div style="width: 10px;">&nbsp;</div>
						<input type="text" name="endDate" class="datepicker2" style="width:205px;">
...
$(document).ready(function(){
	...
	$('#ModeButton').click(function(){
		...
		$.ajax({
			...
			data : {'seq':$('#seq').val(), 'postSelect':$('#postSelect').val(), 'imageName' : $('#imageName').val(), 'startDate' : $('.datepicker1').val(), 'endDate' : $('.datepicker2').val(),'eventPlace' : $('#eventPlace').val()},
			dataType : 'text',
