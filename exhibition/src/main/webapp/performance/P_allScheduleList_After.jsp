...
<body>
	...
	<h2 class="box-container" style="float: center; width: 100%; text-align: left;">
		...
		<span id="sub-high">- 3개월 이후 행사 리스트</span>
	</h2>
	<!-- 버튼 -->
	<div>
...
<br><br>
	...
	<div align="center" style="margin-left:20px; width: 880px;">
		<form name="AllCalendarList_AfterForm" id="AllCalendarList_AfterForm" method="post">
			<table  frame="hsides" border="1px" cellpadding="3" cellspacing="0" width="100%"><!-- rules="rows" -->
				...
				<c:if test="${listSize eq '0'}">	
					<tr>
						<td colspan="3" align="center">이후 계획된 일정이 없습니다</td>
					</tr>
				</c:if>			
